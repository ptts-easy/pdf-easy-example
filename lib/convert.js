...
exports = module.exports = function convert(input_path, quality, callback) {
  ...
  fs.exists(input_path, function (exists) {
    ...
    inputPath = "./pdf_pages/page00001.pdf";
    outputPath = "./pdf_pages/aaa.tif";
    const gsPath = "./ghostscript/gpcl6win64.exe";
  
    const cmd = `"${gsPath}" -sDEVICE=tiffgray -r720x720 -g6120x7920 -sCompression=lzw -o "` + output_path + '" "'+input_path+'"';
